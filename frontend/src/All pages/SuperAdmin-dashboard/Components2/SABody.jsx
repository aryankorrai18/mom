...
//   useEffect(() => {
//     fetch('http://localhost:5000/api/auth/adminProfile', {
//       method: 'GET',
//       headers: {
...
//           <div className='sa-details-card1'>
//             <p className="sa-details-item1"><span className="sa-details-label1">Pending Leave Requests:</span> {adminDetails.pendingLeaveRequests}</p>
//             <p className="sa-details-item1"><span className="sa-details-label1">Total Employees:</span> {adminDetails.totalEmployees}</p>
//           </div>
//         </div>
//       </div>
//     </>
